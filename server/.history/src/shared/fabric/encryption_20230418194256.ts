...
async function verifyCertificateProof({
  ...
  const verificationSuccess = mTree.verifyMultiProof(
    ...
    mTree.getDepth(),
    [
      Buffer.from('0xa665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3', 'hex'),
      Buffer.from('0xd2a3b5b833277a27b29c2b4899bd292882be1219510fb26565c1799a27e7bfe1', 'hex')
    ],
  );

...
function extractDateTimeValues(character : string) {
  const arr = [  'MAHOSO1423',  '123123',  '1212',  'Long Tran gww',  'Pham NGoc Phu',  'CNTT',  '2016-01-01T00:00:00.000Z',  'CNTT',  'hehe',  'DIPLOMA',  0,  'TPHCM',  'Kinh',  'FEMALE'];
  const dateTimeValues = extractDateTimeValues(arr);

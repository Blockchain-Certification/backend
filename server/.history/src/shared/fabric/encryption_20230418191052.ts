...
async function verifyCertificateProof({
  ...
  console.log(mTreeRoot);
  const test: any = [
    '0x60ddbd1415993fb371fb3a802b47d38fd4bc47e1e74dff1e2d64b89e146d2a08',
    '0xa728fbaf6b95852271e79cf43de1f08f55388612627dce1cc5a800258ffda1d4',
  ];
  console.log(mTree.getDepth());
  const verificationSuccess = mTree.verifyMultiProof(
    ...
    [
      ...
      '0xd2a3b5b833277a27b29c2b4899bd292882be1219510fb26565c1799a27e7bfe1'
    ],
  );

...
// check arguments before calling verifyMultiProof function
if (root && proofIndices && proofLeaves && leavesCount && multiProof) {
  const isValid = tree.verifyMultiProof(root, proofIndices, proofLeaves, leavesCount, multiProof);
  console.log(isValid); // outputs "true"
} else {
  console.log("One or more arguments are undefined or null.");
}
  } catch (err) {
    console.log(err);
  }

...
const data = [
  new ObjectId('6440beb80501ceda03f2ffc4'),
  'MAHOSO1423',
  '123123',
  '1212',
  '111033111201',
...
const leaves = data.map((x) => crypto.SHA256(x.toString()).toString(crypto.enc.Hex));

...
async function generateDACProof(
  ...
  const multiProof = mTree.getMultiProof(mTree.getHexLayersFlat(), paramsToShareIndex);

// "0xa665a45920422f9d417e4867efdc4fb8a04alf3fff1fa07e998e86f7f7a27ae3"
  const proofObject = multiProof.map((x) => x.toString('hex'));
  return multiProof;
}

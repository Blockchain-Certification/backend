...
async function verifyCertificateProof({
  ...
  console.log(paramsToShareIndex);
  ...
  try {
    ...
    console.log(leavesTest);
    // verify the multiproofs for the specified leaf indices
    const leavesToVerify = ["leaves[0]", "leaves[1]", "leaves[2]", "leaves[5]", "leaves[6]", "leaves[7]", "leaves[8]", "leaves[11]", "leaves[12]", "leaves[13]", "leaves[14]", "leaves[15]", "leaves[16]", "leaves[21]"] 
